...
hi(0, "CurSearch", { ctermbg = 1, ctermfg = 235, bold = true })
...
hi(0, "PmenuSel", { ctermbg = 235, ctermfg = 5 })
...
hi(0, "Search", { ctermbg = 6, ctermfg = 0 })
...
hi(0, "StatusLine", { ctermbg = 7, ctermfg = 0 })
hi(0, "StatusLineNC", { ctermbg = 8, ctermfg = 0 })
...
hi(0, "Type", { ctermfg = 6 })
hi(0, "Underlined", { ctermfg = 4, underline = true })
