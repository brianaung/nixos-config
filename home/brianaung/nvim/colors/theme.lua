...
hi(0, "DiffAdd", { ctermfg = white, ctermbg = green, bold = true })
hi(0, "DiffChange", { ctermfg = white, ctermbg = blue, bold = true })
hi(0, "DiffDelete", { ctermfg = white, ctermbg = red, bold = true })
hi(0, "DiffText", { ctermfg = white, ctermbg = bright_blue, bold = true })
