...
hi(0, "DiffAdd", { ctermbg = green, bold = true })
hi(0, "DiffChange", { ctermbg = blue, bold = true })
hi(0, "DiffDelete", { ctermbg = red, bold = true })
hi(0, "DiffText", { ctermbg = bright_blue, bold = true })
